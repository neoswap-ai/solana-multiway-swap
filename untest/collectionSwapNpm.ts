...
describe("compressed NFT Test Unit", () => {
    ...
    // let swapDataAccount = ("7Vnt8ifj2w3NrLcbt5dyyqpPnJxsvh7V9x1q7eL1tNw6"); // one way
    ...
    let bid: neoTypes.Bid = {
        ...
        makerNeoswapFee: 1 * 10 ** 7,
        makerRoyalties: 2 * 10 ** 7,
        takerNeoswapFee: 3 * 10 ** 7,
        takerRoyalties: 4 * 10 ** 7,
    };
