...
describe("MIX pre-signing", () => {
    ...
    let swapDataAccount = new PublicKey("4biwJoWAbZgh2nMN17zqHXdugCFxUVHdnXTMawB1N7js");
    ...
    let collection1Data = {
        ...
        items: {
            1: {
                1: "E8Xdbf6vjhfMazYJ65x3R5XAcCuBk8pUwV6eq7fKkaDd",
                2: "AQ1zpbJEo8VR92umCiZzgViJZQt1bDecGbEWAftG4Pnk",
            },
        },
    };
    let collection2Data = {
        collection: "8Jy6UQxitXCStK97t4Lb9AZ5DpHDDWpUXDygmnZY6Rkt",
        items: { 2: { 1: "Avx1CRBGa8urWAjjxo6d3iiAJttu48f5BAF1pCTSFim7" } },
    };
    let collectionFakeData = {
        collection: "5GzuKHXr7FBwZErdfsiUfrwsLpEcmLG8xNb4SmZ3UA1E",
        items: { 2: { 1: "DvA6qbc9DWrKuME2yYhDwCdo2LHxooFrcczuH9nExzXR" } },
    };
    let days = 86400;
    ...
    let swapInfoFakeTaker: neoTypes.SwapInfo = {
        currency: SystemProgram.programId.toString(),
        preSeed,
        status: "initializing",
        duration: 100000,
        ...
        users: [
            {
                ...
                items: {
                    get: [
                        ...
                        {
                            address: collectionFakeData.items[2][1],
                            amount: 1,
                            collection: collection1Data.collection,
                            givers: [{ address: user1.publicKey.toString(), amount: 1 }],
                        },
    ...
    //     if (swapDataAccount) {
    //         console.log("swapInfoTaker", swapInfoFakeTaker);

    //         const hashs = await neoSwap.modifySwap({
    //             clusterOrUrl,
    //             swapDataAccount,
    //             signer,
    //             swapInfo: swapInfoFakeTaker,
    //         });
    //         console.log("hashs", hashs);
    //     } else console.warn("depositing user 2 skipped");
    // });
