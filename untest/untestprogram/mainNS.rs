...
pub mod neo_swap {
    ...
    pub fn initialize_init(
        ...
        require!(sent_data.duration.is_positive(), MYERROR::UnexpectedData);
    ...
    pub fn initialize_add_token(
        ...
        // let nbtk = token_exist_in_sda(swap_data_account.token_items.clone(), token_item.clone());
        // msg!("token item {}", nbtk);
    ...
    pub fn initialize_add_nft(
        ...
        // msg!(
        //     "token item {:#?}",
        //     nft_exist_in_sda(swap_data_account.nft_items.clone(), nft_item.clone())
        // );
    ...
    pub fn initialize_modify_cnft(
        ...
        require!(
            true, // !!collection.verified && collection.key.eq(&trade_to_modify.collection),
            MYERROR::WrongCollection
        );
...
pub struct ValidateAndClose<'info> {
    ...
    #[account(
        ...
        seeds = [&seed[..]],
        bump,
        close = swap_data_account.initializer,
        constraint = swap_data_account.initializer.eq(&signer.key()) @ MYERROR::NotInit
    )]
    swap_data_account: Box<Account<'info, SwapData>>,
    #[account(mut)]
...
// pub fn nft_exist_in_sda(list_of_items: Vec<NftSwapItem>, item_to_check: NftSwapItem) -> i32 {
//     let mut count = 0;
...
//     return count;
// }
// pub fn token_exist_in_sda(list_of_items: Vec<TokenSwapItem>, item_to_check: TokenSwapItem) -> i32 {
//     let mut count = 0;
//     for item in list_of_items {
