...
exports.JijiWalletAdapter = exports.JijiWalletName = void 0;
const wallet_adapter_base_1 = require("@solana/wallet-adapter-base");
const web3_js_1 = require("@solana/web3.js");
exports.JijiWalletName = 'Jiji';
class JijiWalletAdapter extends wallet_adapter_base_1.BaseMessageSignerWalletAdapter {
    constructor(config = {}) {
        super();
        this.name = exports.JijiWalletName;
        this.url = 'https://oneauth.one';
        ...
        if (this._readyState !== wallet_adapter_base_1.WalletReadyState.Unsupported) {
            (0, wallet_adapter_base_1.scopePollingDetectionStrategy)(() => {
                var _a;
                if (((_a = window.jiji) === null || _a === void 0 ? void 0 : _a.isJiji) || window.JijiApp) {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let JijiClass;
                try {
                    JijiClass = (yield Promise.resolve().then(() => __importStar(require('@solflare-wallet/sdk')))).default;
                }
                catch (error) {
...
exports.JijiWalletAdapter = JijiWalletAdapter;
