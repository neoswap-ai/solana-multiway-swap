...
export const userAddItemToSell = async (Data: {
    ...
    const addUserItemToAddIx = await Data.program.methods
        .userAddItemToSell(userBump, Data.itemToSell)
        .accounts({
            userPda,
            itemToDelegate,
            signer: Data.signer,
    ...
    let userAddItemToSellTransaction: {
        tx: Transaction;
        signers?: Array<Signer> | undefined;
    ...
    // const userAddItemToSellTransaction = await convertAllTransaction(userAddItemToSellTransaction);

    return { userAddItemToSellTransaction };
};
