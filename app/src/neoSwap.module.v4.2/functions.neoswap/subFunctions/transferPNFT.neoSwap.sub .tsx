...
// import { splAssociatedTokenAccountProgramId, TOKEN_METADATA_PROGRAM } from '../../utils.neoSwap/const.neoSwap';
...
//     if (itemFromDepositTx) {
//         depositAllIx.push(...itemFromDepositTx);
//         console.log('added itemFromDepositTx');
//     }
...
//     });
//     if (itemToDepositTx) {
//         depositAllIx.push(...itemToDepositTx);
//         console.log('added itemFromDepositTx');
//     }
...
//     authRulesProgram = new PublicKey('auth9SigNpDKz4sJJ1DfCTuZrZNSAgh9sFD3rboVmgg'); // metaplex
...
//     authRules = new PublicKey('eBJLFYPxJmMGKuFwpDWkzxZeUrad92kZRC5BJLpzyT9'); //eBJLFYPxJmMGKuFwpDWkzxZeUrad92kZRC5BJLpzyT9  metaplex  Cou6RHLzfRRiGcPpG4o6LRSTaFf39FDmAbYf9RgfnWXk //created
...
//     console.log('ownerTo:', Data.destinary.toBase58());
